...
##  tar -czvf /hy-tmp/myfolder.tar.gz myfolder/   压缩      tar -czvf /hy-tmp/lps3d/lps_new2_4d_241016_085944.tar.gz /hy-tmp/lps3d/lps_new2_4d_241016_085944/
...
##  oss cp /hy-tmp/lps3d/lps_new2_4d_241016_085944.tar.gz oss://datasets/     复制/hy-tmp/到个人数据
##  oss cp oss://datasets/lps_new1_3d_241015_151109.tar.gz I:\intan_new\   复制个人数据到本地电脑  需要在oss终端使用
...
##  rm /path/to/your/folder/*.rhd            rm /hy-tmp/lps3d/lps3d+3_240821_161510/*rhd
##  rm -r example_folder           rm -r /hy-tmp/lps3d/lps3d+3_240821_161510
...
#
#     # 设置根目录
#     input_root_folder = Path(r'/hy-tmp/lps3d')#########更换成云服务器的路径
#
#     # 设置日志记录
